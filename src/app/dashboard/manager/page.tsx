import { getLeaveRequestsForManager, getAppUser, getFallbackUserId } from '@/lib/data';
            ...
            <Card>
                ...
                <CardContent>
                    {managerRequests.length > 0 ? (
                        <LeaveRequestsTable requests={managerRequests} variant="manager" currentUserId={userId} />
                    ) : (
                        <Alert>
